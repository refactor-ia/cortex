...
func testReceipt() Receipt {
	...
	receipt := Receipt{
		...
		BackendIdentity: BackendIdentity{Contract: BackendIdentityContract, Backend: "pi", ModelRelationship: ModelRelationshipRouted},
		...
		Binary:          BinaryIdentity{Contract: "cortex.qa.pi-binary.v1", SHA256: hash, SizeBytes: 1},
