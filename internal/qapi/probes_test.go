...
func TestProbeModel(t *testing.T) {
	...
	tests := []struct {
		...
		{"dynamic header whitespace is accepted", modelInput([]byte(" \tprovider\t model  context\tmax-out thinking images \t\r\nnan qwen3.6 262.1K 16.4K yes yes\r\n")), "nan", "qwen3.6", true, ""},
		{"missing requested model remains unavailable", modelInput([]byte("provider model context max-out thinking images\nnan qwen3.6 262.1K 16.4K yes yes\n")), "nan", "glm9.9-absent", false, qaadmission.CodeModelUnavailable},
		{"wrong header token fails normalization", modelInput([]byte("provider model context max-out thinking images-wrong\nnan qwen3.6 262.1K 16.4K yes yes\n")), "nan", "qwen3.6", false, qaadmission.CodeNormalizationFailed},
		{"missing header token fails normalization", modelInput([]byte("provider model context max-out thinking\nnan qwen3.6 262.1K 16.4K yes yes\n")), "nan", "qwen3.6", false, qaadmission.CodeNormalizationFailed},
		{"extra header token fails normalization", modelInput([]byte("provider model context max-out thinking images extra\nnan qwen3.6 262.1K 16.4K yes yes\n")), "nan", "qwen3.6", false, qaadmission.CodeNormalizationFailed},
		{"reordered header tokens fail normalization", modelInput([]byte("model provider context max-out thinking images\nnan qwen3.6 262.1K 16.4K yes yes\n")), "nan", "qwen3.6", false, qaadmission.CodeNormalizationFailed},
		{"header-only table remains unavailable", modelInput([]byte(modelTableHeader + "\n")), "nan", "qwen3.6", false, qaadmission.CodeModelUnavailable},
		{"five-field row fails normalization", modelInput([]byte("provider model context max-out thinking images\nnan qwen3.6 262.1K 16.4K yes\n")), "nan", "qwen3.6", false, qaadmission.CodeNormalizationFailed},
		{"seven-field row fails normalization", modelInput([]byte("provider model context max-out thinking images\nnan qwen3.6 262.1K 16.4K yes yes extra\n")), "nan", "qwen3.6", false, qaadmission.CodeNormalizationFailed},
